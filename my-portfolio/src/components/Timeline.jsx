...
const timelineData = [
  {
    ...
    date: "2022-05",
    subtitle:
      "어깨 너머로만 보던 IT 분야... 직접 공부하고 배우면서 꿈을 키우게됩니다.",
    tags: ["Turning Point"],
    titleUrl: "#",
  },
  {
    ...
    date: "2022-11",
    subtitle:
      "IT 개발자로서 첫 취직을 해 꿈을 향해 달려가 볼 수 있는 기회를 얻었습니다.",
    tags: ["First Career"],
    titleUrl: "#",
  },
  {
    ...
    date: "2023-01",
    subtitle:
      "본격 커리어의 시작! 처음으로 팀원들과 업무에 대해 회의를 진행하면서 협업을 진행해보았습니다. 이름하여 Xafe 프로젝트!",
  ...
  },
  {
    ...
    date: "2024-03",
    subtitle:
      "저의 기획으로 탄생한 BJMCU 프로젝트! 모듈 테스트 간소화를 통해 팀 업무에 기여했습니다.",
  ...
  },
  {
    ...
    date: "2024-10",
    subtitle:
      "실시간 메신저 웹 애플리케이션을 개발을 진행하게 되면서 디자인도 맡아서 기획해 볼 수 있었고, React.js라는 언어와 저에 대해 보다 심층적으로 접근해 볼 수 있었습니다.",
  ...
  },
  {
    ...
    date: "2025-03",
    subtitle:
      "새로운 곳에서 더 발전하고 도약하는 프론트엔드 개발자가 되기 위해 새로운 도전을 시도했습니다. 두번째 터전에서!",
    tags: ["Second Career"],
    titleUrl: "#",
  },
  {
    ...
    date: "2025-03",
    subtitle:
      "LG이노텍과 LG복지몰에 Hcaptcha를 최초로 도입해 사이트 보안에 기여했습니다.",
    tags: ["JSP", "Hcaptcha"],
    titleUrl: "#",
  },
  {
    ...
    date: "2025-07",
    subtitle:
      "원그로브몰 구축 프로젝트의 메인 프론트엔드 개발자로써 서비스 오픈까지 성공적으로 주도했습니다!.",
...
const TimelineItem = styled.li`
  ...
  transform: ${({ side }) =>
    side === "left" ? "translateX(-5%)" : "translateX(5%)"};
...
const EventContent = styled.div`
  ...
  box-shadow: 6px 6px 12px rgba(0, 0, 0, 0.3),
    /* 바깥 그림자를 줄이고 투명도 조정 */ -6px -6px 12px
      rgba(255, 255, 255, 0.05),
    /* 밝은 양각 그림자 최소화 */ inset 3px 3px 5px rgba(0, 0, 0, 0.4),
    /* 내부 어두운 음영 */ inset -3px -3px 5px rgba(255, 255, 255, 0.1); /* 내부 밝은 음영 */
  padding: 20px;
